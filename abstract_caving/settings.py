"""
Django settings for abstract_caving project.
...
ROOT_URLCONF = 'abstract_caving.urls'

WSGI_APPLICATION = 'abstract_caving.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'abstract_caving/static'),
)
# Make sure it checks "main" for base/building block templates
TEMPLATE_DIRS = (
